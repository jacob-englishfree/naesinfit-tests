...
const VALID_TEXTBOOK_PATHS = [
  ...
  '공통영어1/천재조수경',
  '공통영어2/YBM김은형', '공통영어2/YBM박준언', '공통영어2/능률민병천',
  '공통영어2/능률오선영', '공통영어2/동아이병민', '공통영어2/미래엔김성연',
  '공통영어2/비상홍', '공통영어2/지학사신상근', '공통영어2/천재강상구',
  '공통영어2/천재조수경',
  '영어1/YBM박준언', '영어1/능률오선영', '영어1/동아박용예',
  '영어1/미래엔김성연', '영어1/비상홍', '영어1/지학사신상근',
  '영어1/천재강상구', '영어1/천재조수경',
  '영어2/YBM한상호', '영어2/YBM박준언', '영어2/능률오선영',
  '영어2/지학사신상근', '영어2/천재조수경', '영어2/미래엔김성연',
  '영어2/비상홍',
  '중2/YBM김은형',
  '중3/미래엔최연희',
];

const VALID_SUPPLEMENT_PATHS = ['수능특강/영어', '수능특강/영어독해연습', '수능특강Light/영어', '수능특강Light/영어독해연습', '올림포스전국연합고1_2026', '올림포스전국연합고2/2026', '올림포스독해의기본1/2025', '올림포스독해의기본2/2025', 'ReadingPower유형편완성', '빠른독해바른독해_구문독해_2024'];
